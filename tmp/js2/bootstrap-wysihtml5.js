    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<a class='btn btn" + size + " btn-default' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><i class='fa fa-th-list'></i></a>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                ...
                "</div>" +
                "</div>" +
                "<a class='btn btn" + size + " btn-default' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><i class='fa fa-image'></i></a>" +
                "</li>";
        },
