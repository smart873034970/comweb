...
<div class="panel panel-default collapse" id="collapseInfo">
        <div class="panel-body">
            <table id="table-basic" class="table table-striped dataTable" role="grid" aria-describedby="table-basic_info">
                ...
                <?php
                    $index_count = 0;
                    $max_count = 6; //the a page max show
                    ...
                    foreach($email_all as $value){
                        ...
                        printf('<tr class="gradeA odd" role="row" >
                    	<td>%s</td>
                    	<td>%s</td>
                    	<td>%s</td>
                    	<td>%s</td>
                        ...
                        <ul class="pagination">
                            ...
                            <?php 
                                ...
                                for($tmp_i=0; $tmp_i<$page_count; $tmp_i++){
                                    printf('<li><a href="#">%s</a></li>', ($tmp_i+1));
                                }
                            ?>
                            <li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-danger btn-sm" onclick="isdel()">确定</button>
        </div>
    </div>
  </div>
</div>
