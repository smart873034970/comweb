                ...
                <ul class="nav navbar-nav navbar-nav-expanded pull-right margin-md-right">
                        ...
                        <ul class="dropdown-menu dropdown-messages pull-right">
                            ...
                            <li class="unread">
                                <a href="javascript:;" class="message">
                                    <img class="message-image img-circle" src="images/1.jpg">
                            ...
                            <li class="unread">
                                <a href="javascript:;" class="message">
                                    <img class="message-image img-circle" src="images/3.jpg">
                            ...
                            <li>
                                <a href="javascript:;" class="message">
                                    <img class="message-image img-circle" src="images/8.jpg">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right-xs">
                            ...
                            <li class="divider"></li>
                            <li><a href="login_check/login_out">注销</a></li>
                        </ul>
                    </li>
                </ul>
                ...
                ?>
                    <div class="profile-body">
                        ...
                        <div class="sidebar-user-links">
                            ...
                            <a class="btn btn-link btn-xs" href="login_check/login_out" data-placement="bottom" data-toggle="tooltip" data-original-title="Logout"><i class="fa fa-sign-out"></i></a>
                        </div>
                    </div>
                </div>
                <nav>
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li class="nav-dropdown active open">
                            <a href="#" title="Dashboards">
                                <i class="fa fa-lg fa-fw fa-home"></i> 主页
                            </a>
                            <ul class="nav-sub">
                                <li class="active open">
                                    <a onclick="nav_get('company_infomation')" title="Dashboard">
                                        <i class="fa fa-fw fa-caret-right"></i> 公司信息
                                    </a>
                                </li>
                                <li>
                                    <a onclick="nav_get('new_release')"title="Analytics Overview">
                                        <i class="fa fa-fw fa-caret-right"></i> 最新发布
                        ...
                        <li class="nav-dropdown">
                            <a href="#" title="Users">
                                <i class="fa fa-lg fa-fw fa-user"></i> 我
                            </a>
                            <ul class="nav-sub">
                                <li>
                                    <a onclick="nav_get('my_home')"title="Members">
                                        <i class="fa fa-fw fa-caret-right"></i> <span>我的主页</span>
                                    </a>
                                </li>
                                <li>
                                    <a onclick="nav_get('my_team')" title="Profile">
                                        <i class="fa fa-fw fa-caret-right"></i> 我的团队
                                    </a>
                                </li>
                                <li>
...
<!-- modal end -->
        ...
        // 用于目录异步获取信息
            function nav_get(name){
                ...
                nav_get('company_infomation');    //默认显示公司信息
